...
##### 1. Did NOT Reach Rated Power; 2. Reach Rated Power


### 1. DID NOT Reached Rated Power 
...
for (i in 1:NROW(wtgNotReachRated)) {
  ...
  powercurve <- csvPower %>%
    ...
    labs(x = "Windspeed", y = "RealPower", title = paste0("WTG-", wt, " Power Curve"), color = "") +
